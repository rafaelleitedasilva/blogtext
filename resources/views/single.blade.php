...
@section('content')
  ...
  <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('{{Vite::asset('resources/images/avatar/avatar.jpg')}}');">
    <div class="container">
        ...
        <div class="col-md-12">
          <div class="post-entry text-center">
            ...
            <div class="post-meta align-items-center text-center">
              <figure class="author-figure mb-0 me-3 d-inline-block"><img src="{{Vite::asset('resources/images/avatar/avatar.jpg')}}" alt="Image" class="img-fluid"></figure>
        ...
        <div class="col-md-12 col-lg-8 main-content">
          ...
          <div class="pt-5 comment-wrap">
            ...
            <ul class="comment-list">
              <li class="comment">
                <div class="vcard">
                  <img src="{{Vite::asset('resources/images/avatar/avatar.jpg')}}" alt="Image placeholder">
                </div>
        ...
        <div class="col-md-12 col-lg-4 sidebar">
          ...
          <div class="sidebar-box">
            <div class="bio text-center">
              <img src="{{Vite::asset('resources/images/avatar/avatar.jpg')}}" alt="Image Placeholder" class="img-fluid mb-3">
              <div class="bio-body">
          ...
          <div class="sidebar-box">
            ...
            <div class="post-entry-sidebar">
              <ul>
                <li>
                  <a href="">
                    <img src="{{Vite::asset('resources/images/avatar/avatar.jpg')}}" alt="Image placeholder" class="me-4 rounded">
                    <div class="text">
